#debuglevel 10
setvariable storage pack
setvariable jugglies mills
setvariable coin-to-carry 400 silver
setvariable origami-instructions
setvariable origami-completed 
setvariable appraisal.tool gem pouch
setvariable train.climb on
setvariable commodities on
setvariable interior on
setvariable caravan horse-drawn caravan
setvariable compendium on
setvariable train.vocals off
setvariable song-1 lament loud
setvariable song-2 hymn loud
setvariable song-3 rumba halting
...
#%_____________________________________________________________________________________________________________
     ...
     if "%interior" = "on" then action setvariable arrived 1 when You feel the momentum of the room shift and then hear a voice from outside announce, "We have arrived!"
...
echo .
     ...
     action setvariable get-contract 1 when (Have a delinquent contract|Have no contracts pending)
...
Stone-Continue:
     ...
     gosub verb tell caravan to follow
     if "$roomname" != "Foothills, Stony Incline" then gosub move-c down
...
exhale:
     ...
     setvariable poked 0
     if "$roomname" = "Lairocott Brach, Entrance" then gosub sc-statue-ori
     pause 0.5
