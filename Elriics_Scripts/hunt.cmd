########################################################
#Edited by the player of Isharon to work with Combat 3.0
#*replaced skill checks with 3.0 skill names
#*removed humming and all references thereto
#*replaced damaging combat maneuvers with attack (kludge)
#*Note: I have not edited the timing, so additional tweaks may be needed for fatigue management.
#*This script includes the Geniebuff add-on and some of my other modifications. I have not edited Geniebuff. It will not work properly in 3.0 until the new spells and spell variables have been done.
########################################################
...
## FEINT: use a attacking routine to keep balance up                   ##
...
action (hunt) goto STAND when ^You must stand first|^You should stand up first|^You had better stand up first
...
action (stalk) put #send put #script pause hunt;put #send 1 walk %starter.room;put #send 2 put #script resume;put #echo >Log Returned to starting room when eval $roomid != %starter.room
action (stalk) off
action (hunt) put #var GH_BARRAGE_FULL_TARGET OFF when You gesture
action (hunt) put #var GH_BARRAGE_FULL_TARGET ON when Your formation of a targeting pattern
...
var junkloot claw-tipped arrow|scroll|tablet|vellum|sheiska leaf|ostracon|hhr'lav'geluhh bark|papyrus roll|smudged parchment|\bmap\b|soulstone|albredine ring|crystal ring|flarmencrank|\bgear\b|glarmencoupler|\bnuts?\b|rackensprocket|spangleflange|(kertig|lumium|damite|niniam|animite|audrualm|tyrium|haralun|glaes|platinum|electrum|gold|silver|silversteel|icesteel) (nugget|shard|fragment|tear|lump|bar|ingot|fist)
var collectibles \bmap\b|soulstone
##Monster Variables
...
var monsters2 fire maiden|creeper|vine|thug|ruffian|footpad|cutthroat|gypsy marauder|young ogre|swain|graverobber|kra'hei hatchling
...
var monsters7 faenrae assassin|telga moradu|trekhalo|orc clan chief|shadow master|malchata|sky giant|imp|dummy|clay mage|clay soldier|clay archer|sentinel|zealot|juggernaut
...
var skinnablemonsters1 frog|silverfish|musk hog|grub|crayfish|burrower|crab|boar|skunk|badger|pothanit|trollkin|brocket deer|deer
...
var skinnablemonsters3 serpent|firecat|vulture|arbelog|caiman|steed|larva|snowbeast|sow|worm|unyn|gargoyle|crocodile|Isundjen conjurer
...
var skinnablemonsters9 warklin mauler|armored warklin
...
var skinnablecritters %skinnablemonsters1|%skinnablemonsters2|%skinnablemonsters3|%skinnablemonsters4|%skinnablemonsters5|%skinnablemonsters6|%skinnablemonsters7|%skinnablemonsters8|%skinnablemonsters9|%skinnableundead1|%skinnableundead2
...
var OPTIONVARS AMB.*?|APPR.*?|ARM.*?|ARRA.*?|BACKS.*?|BAST.*?|BLO.*?|BRA.*?|BS|BUF.*?|BUN.*?|COLL.*?|COUNT|CUST.*?|DANCE|DANG.*?|DEF.*?|DMSET|DMULTI|DODGE|DSET|DYING|EMP.*?|EVA.*?|EXP|FEINT|HELP|HUNT|JUGG.*?|JUNK|LOOTA.*?|LOOTB.*?|LOOTC.*?|LOOTG.*?|MAGIC|MANIP|MSET|MULTI|NECROH.*?|NECROR.*?|NOEV.*?|NOPA.*?|NOSH.*?|OFF.*?|PARALYSIS|PARRY|PM|POACH|POUCH|POW.*?|PP|RET.*?|ROAM|SCRAPE.*?|SEARCH|SKIN.*?|SKINRET.*?|SLOW|SNAP|SNIP.*?|STACK|STANCE|SWAP|TARG.*?|TEND|THROW\b|TIE|TIME.*?|TARGETTING.*?|DEBIL.*?|SUMMON.*?|TACTICS|TRAIN|TSWAP|WEAR|YOYO
var OPTION NONE
...
## Attack Init
put #var GH_Attack_Inline_Counter 0

## Tactics init
put #var TACTICS_INLINE NO

## Barrage Init
put #var GH_BARRAGE_ALLOW OFF
put #var GH_BARRAGE_FULL_TARGET OFF

## Inline Init
put #var GH_Inline_Counter 1

## Targetting Init
put #var TARGETTING_Counter 0
put #var TARGETTING_INLINE NO

## Debilitation init
put #var GH_Debilitation_Counter 0
put #var DEBIL_INLINE NO

## SUMMONING init
put #var GH_SUMMON_Counter 0
put #var SUMMON_INLINE NO

## Appraisal init
var APPRAISE_COMBAT true 
...
## ON - Uses a attacking routine (attack slice, etc) to maintain balance
...
action var guild $1;put #var guild $1 when Guild: (.*)
...
TARGETTING:
	...
	{
		echo
		echo *** TARGETTING_INLINE: ***
		echo
	}
	put #var TARGETTING_INLINE YES
	return
...
ARMOR:
	...
	if $swap.LearningRate >= 16 then put #var swap.learningrate 30
	return
...
DMULTI:
	...
	DMULTI_2:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_2
	DMULTI_3:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_3
	DMULTI_4:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_4
	DMULTI_5:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_5
	DMULTI_6:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_6
	DMULTI_7:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_7
	DMULTI_8:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_8
	DMULTI_9:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_9
	DMULTI_10:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_10
	DMULTI_11:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_11
	DMULTI_12:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_12
	DMULTI_13:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_13
	DMULTI_14:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_14
	DMULTI_15:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_15
	DMULTI_16:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_16
	DMULTI_17:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_17
	DMULTI_18:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_18
	DMULTI_19:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_19
	DMULTI_20:
		put .hunt MULTIWEAPON $GH_MULTI_WEAPON_20
	DMULTI_ERROR:
		echo
		echo *** DMULTI_ERROR: ***
...
## This will use attack during combat to keep balance up
FEINT:
	if ("%GAG_ECHO" != "YES") then
	{
		echo
...
MULTI:
	...
	MULTI_2:
		put .hunt MULTIWEAPON $GH_MULTI_2
	MULTI_3:
		put .hunt MULTIWEAPON $GH_MULTI_3
	MULTI_4:
		put .hunt MULTIWEAPON $GH_MULTI_4
	MULTI_5:
		put .hunt MULTIWEAPON $GH_MULTI_5
	MULTI_6:
		put .hunt MULTIWEAPON $GH_MULTI_6
	MULTI_7:
		put .hunt MULTIWEAPON $GH_MULTI_7
	MULTI_8:
		put .hunt MULTIWEAPON $GH_MULTI_8
	MULTI_9:
		put .hunt MULTIWEAPON $GH_MULTI_9
	MULTI_10:
		put .hunt MULTIWEAPON $GH_MULTI_10
	MULTI_11:
		put .hunt MULTIWEAPON $GH_MULTI_11
	MULTI_12:
		put .hunt MULTIWEAPON $GH_MULTI_12
	MULTI_13:
		put .hunt MULTIWEAPON $GH_MULTI_13
	MULTI_14:
		put .hunt MULTIWEAPON $GH_MULTI_14
	MULTI_15:
		put .hunt MULTIWEAPON $GH_MULTI_15
	MULTI_16:
		put .hunt MULTIWEAPON $GH_MULTI_16
	MULTI_17:
		put .hunt MULTIWEAPON $GH_MULTI_17
	MULTI_18:
		put .hunt MULTIWEAPON $GH_MULTI_18
	MULTI_19:
		put .hunt MULTIWEAPON $GH_MULTI_19
	MULTI_20:
		put .hunt MULTIWEAPON $GH_MULTI_20
	MULTI_ERROR:
		echo
		echo *** MULTI_ERROR: ***
...
SKIN:
	...
	var BELT_WORN OFF
	action var BELT_WORN ON when ^You tap a(.+)knife(.*)you are wearing
	put tap my knife
	pause 1
	action remove ^You tap a(.*)knife(.*)you are wearing
	put #var GH_SKIN ON
	return
...
SHEATHE:
	...
	WEAR_WEAPON:
		...
		matchwait 12
	STOW_WEAPON:
			matchre RETURN You put|easily strap|already in your inventory|You slip
...
RANGE_SHEATHE:
	...
	STOW_AMMO:
		...
		if "%AMMO" = "claw-tipped arrow" then put stow claw arrow
		else
		put stow %AMMO
		matchwait 40
	GO_ON:
...
#####################################
GENERAL_TRIGGERS:
	action (hunt) goto STAND when eval $standing = 0
	action (hunt) goto STAND when ^You must stand first|^You should stand up first|^You had better stand up first
	...
	action (hunt) goto WEBBED when eval $webbed = 1
	action (hunt) goto WEBBED when You can't do that while entangled in a web
	...
	action var lastmaneuver attack when Last Combat Maneuver.*Feint
	...
	action var lastmaneuver dodge when Last Combat Maneuver.*3
...
APPR_YES:
	if (("%APPRAISED" = "YES") || ($Appraisal.LearningRate > 32)) then goto COUNT_$GH_DANCING
...
NO_MONSTERS:
	...
	if ("$GH_BUFF" = "ON") then gosub GH_BUFF_ON
	if ("%RANGED" = "ON") then
	{
	...
	if ("%SEARCHED" = "NO") && matchre ("$roomobjs", "((which|that) appears dead|\(dead\))") then goto DEAD_MONSTER
	if ((toupper("$GH_JUGGLE") = "ON") && ($Perception.LearningRate < 16)) then goto JUGGLE_STUFF
...
500:
	...
	counter set 500
	save 500
	if ("%lastmaneuver" = "5") then gosub COMBAT_COMMAND %COMBO1
...
AIM:
	...
	math AIM_TIMEOUT add 30
		...
		matchre FACE ^There is nothing|Face what
	put aim
	matchwait 80
	goto RANGED_ERROR
...
######################################
COMBAT_COMMAND:
	if (("$GH_FEINT" = "ON") && (("$0" != "attack") && ("$0" != "parry") && ("$0" != "dodge"))) then var COMMAND attack $0
	else var COMMAND $0
	...
	if ((toupper("$GH_AMBUSH") = "ON") && ($hidden != 1)) then
	{
		...
		elseif (($Stealth.LearningRate < 16) && ($Stealth.LearningRate < 16)) then gosub HIDE
	}
	if ((toupper("$GH_HUNT") = "ON") && (%t >= %HUNT_TIME) && ($Perception.LearningRate < 16) && ($Stealth.LearningRate < 16)) then
	{
		put hunt
		var HUNT_TIME %t
	...
	if ((toupper("$GH_MANIP") = "ON") && (%t >= %MANIP_TIME) && ($Empathy.LearningRate < 16) then
	{
		gosub MANIPULATE1
		var MANIP_TIME %t
		math MANIP_TIME add 75
	}
	if ((toupper("$GH_PARALYSIS") = "ON") && (%t >= %PARALYSIS_TIME) && ($Targeted_Magic.LearningRate < 30) && ($mana >= 95) then
	{
		var paralysis.index 0
		gosub TMPARALYSIS
		var PARALYSIS_TIME %t
		math PARALYSIS_TIME add 150
	}
	if ((toupper("$GH_PP") = "ON") && (%t >= %PP_TIME) && ($Attunement.LearningRate < 16)) then
	{
	...
	if (($Debilitation.LearningRate < 30) && ("%guild" = "Barbarian")) then put roar quiet embrace
#       put #echo GREEN TEST: $GH_Inline_Counter
#       if ($GH_Inline_Counter < 1) then
#        {
#                   put #var GH_Inline_Counter 0
#                   put #math GH_Inline_Counter add 1
#                   put #echo GREEN RESETTING COUNTER: $GH_Inline_Counter
                   if ("$DEBIL_INLINE" = "YES") then
                   {
        		if (("%guild" = "Cleric") && ($mana > 30)) then
        		{
				put #echo GREEN Debil - I'm executing a Debil cast
       				pause
       				put #var DebilitationSpell Phelim's Sanction
       				pause
        			put #send prep $DebilitationSpell 1
        			waitfor You begin chanting catechisms
        			pause .2
#        			put #send charge my $cambrinth 2
#        			waitfor You harness
#        			pause
#        			put #send invoke my $cambrinth spell
#        			waitfor Roundtime
        			pause 15
        			put #send cast
        			pause .5
        			put #send release spell
        			pause
        		}
          		if (($Debilitation.LearningRate < 34) && ("%guild" = "Paladin") && ($mana > 40)) then
          		{
          			put #send prep SF 10
         ...
         # 			pause .2
        		...
        		if (($Debilitation.LearningRate < 34) && ("%guild" = "Necromancer") && ($mana > 40)) then
        		{
        			pause
        			put #send prep Burden 10
        			waitfor You raise your hands skyward
        			pause .2
        			put #send charge my $cambrinth 5
        			waitfor You harness
        			pause
        			put #send invoke my $cambrinth spell
        			waitfor Roundtime
        ...
        #			pause .2
        		...
        		if (($Debilitation.LearningRate < 34) && ("%guild" = "Moon Mage") && ($mana > 40)) then
        		{
        			pause
        			put #send prep Dazzle 10
        			waitfor You raise your head skyward
        			pause .2
        			put #send charge my $cambrinth 7
        			waitfor You harness
        			pause
        			put #send invoke my $cambrinth spell
        			waitfor Roundtime
        ...
        #			pause .2
        	        ...
        	        put #echo BLUE Debil - %guild: $mana
        #		if (($Debilitation.LearningRate < 34) && ("%guild" = "Warrior Mage") && ($mana > 40)) then
        		if (("%guild" = "Warrior Mage") && ($mana > 30)) then
        		{
                           put #echo GREEN Debil - I'm executing a Debil cast
        			if ($GH_Debilitation_Counter = 0) then
        			{
        				pause
        				put #var GH_Debilitation_Counter 0
        				pause
        				put #var DebilitationSpell MOA
        				pause
        			}
        			else if ($GH_Debilitation_Counter = 1) then
        			{
              				pause
        				put #var GH_Debilitation_Counter 0
        				pause
        				put #var DebilitationSpell TC
        				pause
        			}
#        			else if ($GH_Debilitation_Counter = 2) then
#        			{
#        				pause
#        				put #var GH_Debilitation_Counter 0
#        				pause
...
#        			}
        			pause
        			put #send prep $DebilitationSpell 15
        			waitfor Heatless orange flames blaze between your fingertips
        			pause .2
        			put #send charge my $cambrinth 10
        			waitfor You harness
        			pause
        			put #send invoke my $cambrinth spell
        			waitfor Roundtime
        	...
        	if ("$TARGETTING_INLINE" = "YES") then
        	{
	       		put #echo ORANGE TM - %guild: $mana
        		if (("%guild" = "Cleric") && ($mana > 30)) then
        		{
                           put #echo GREEN TM - I'm executing a TM attack
        			if ("$TARGETTING_Counter" = 0) then
        			{
        				pause
        				put #var TARGETTING_Counter 1
        				pause
        				put #var TargettingSpell HORN.5
        				pause
        			}
        			else if ($TARGETTING_Counter = 1) then
        			{
        				pause
        				put #var TARGETTING_Counter 0
        				pause
        				put #var TargettingSpell FF.5
        				pause
        			}
        			pause .2
        			put #send target $TargettingSpell
        			waitfor You begin chanting catechisms
        			pause .2
				put #send charge my $cambrinth 5
        			waitfor You harness
				...
				put #send cast
	       		...
	       		if (($Targeted_Magic.LearningRate < 34) && ("%guild" = "Necromancer") && ($mana > 40)) then
        		{
        			pause .2
        			put #send target Strange Arrow 10
        			waitfor You raise your hands skyward
        			pause .2
        			put #send charge my $cambrinth 5
        			waitfor You harness
        		...
        		if (($Targeted_Magic.LearningRate < 34) && ("%guild" = "Moon Mage") && ($mana > 40)) then
        		{
        			pause .2
        			put #send target PD 10
        			waitfor You raise your head skyward
        			pause .2
        			put #send charge my $cambrinth 5
        			waitfor You harness
        		...
        		if (($Targeted_Magic.LearningRate < 34) && ("%guild" = "Paladin") && ($mana > 40)) then
        		{
        			pause .2
        			put #send target FST 15
        			waitfor You begin chanting a psalm to invoke
        			pause .2
        			put #send charge my $cambrinth 5
        			waitfor You harness
        			pause
        		...
        		put #echo BLUE TM - %guild: $mana
        #		if (($Targeted_Magic.LearningRate < 34) && ("%guild" = "Warrior Mage") && ($mana > 40)) then
        		if (("%guild" = "Warrior Mage") && ($mana > 30)) then
        		{
                           put #echo GREEN TM - I'm executing a TM attack
#				put #var TargettingSpell FS.30
        			if ("$TARGETTING_Counter" = 0) then
        			{
					pause .2
					if ("$AB" = "ON") then
					{
						put #echo ORANGE RELEASE - Releasing Air Bubble to force recast!
						pause
						put release AB
						pause
					}
        				...
        				put #var TARGETTING_Counter 1
        				pause
        				put #var TargettingSpell FB.30
        				pause
        			}
#        			else if ($TARGETTING_Counter = 1) then
#        			{
#        				pause
#        				put #var TARGETTING_Counter 2
#        				pause
#        				put #var TargettingSpell FS.15
#        				pause
#        			}
#        			else if ($TARGETTING_Counter = 2) then
#        			{
#        				pause
#        				put #var TARGETTING_Counter 0
#        				pause
...
#        			}
					...
					if ("$BG" = "ON") then
					{
						put #echo ORANGE WAVE - I'm executing 3 WAVES to shear BG!
						pause
						put wave %Monster
						pause
						put wave %Monster
        				...
        				if ("$DB" = "ON") then
					{
						put #echo ORANGE SPIT - I'm executing 3 SPIT to shear DB!
						pause
						put exhale %Monster
						pause
						put exhale %Monster
        			...
        			waitfor Heatless orange flames blaze between your fingertips
        			pause .2
        			if ("$TargettingSpell" != "Shockwave.30") then
				{
					put #send charge my $cambrinth 10
	        			waitfor You harness
	        			pause
...
#      	} else put #var GH_Inline_Counter 1
#      	} else put #math GH_Inline_Counter add 1
#      	} else put #var GH_Inline_Counter 0

	if ("$SUMMON_INLINE" = "YES") then
	{
##		if (($Summoning.LearningRate < 34) && ("%guild" = "Warrior Mage") && ($mana > 30)) then
		if (("%guild" = "Warrior Mage") then
		{
			gosub BARRAGE.CHECK
			if $GH_BARRAGE_ALLOW = ON then
			{
				pause
				put #send pathway focus quick
				pause .2
				put #var GH_BARRAGE_ALLOW OFF
				pause .2
			}
...
##	if (($Debilitation.LearningRate < 34) && ("%guild" = "Warrior Mage") && ($mana > 40)) then
	if ("$TACTICS_INLINE" = "YES" && $Tactics.LearningRate < 30 && %WEAPON_EXP != Bow && %WEAPON_EXP != Crossbow) then gosub TACTICSTRAIN
	pause .5
	pause .5
	if (($Augmentation.LearningRate < 15) && ("%AUGMENTATION" = "off") && ("%WARDING" = "off") && ("%guild" = "Barbarian")) then
	{
		put form monkey
		var AUGMENTATION on
		pause .5
	...
	pause 1
	if (($Warding.LearningRate < 15) && ("%WARDING" = "off") && ("%AUGMENTATION" = "off") && ("%guild" = "Barbarian")) then
	{
		put form swan
		var WARDING on
		pause .5
...
ATTACK:
        ##	if ($Tactics.LearningRate < 30 && %WEAPON_EXP != Bow && %WEAPON_EXP != Crossbow) then gosub TACTICSTRAIN
        	if matchre ("$roomobjs", "((which|that) appears dead|\(dead\))") then goto DEAD_MONSTER
        	if ("$GH_APPR" = "YES") then gosub APPRAISE_COMBAT
        	else pause .2
        		...
        		matchre RETURN You are already in a position|But you are already dodging|You move into a position to|Roundtime|must be hidden|What were you|What are you|There's nothing you can really|You see nothing here|Eh? But you're already hidden!|You melt into the background|You raise your arms skyward|ADD IT HERE
        	if ("$smite" = "true") then
        	{
        	...
        	var COMMAND smite
                ...
                put #ECHO ORANGE Yo attack mode! %COMMAND
                pause .5
                if ("%RANGED" = "OFF" && "%THROWN" = "OFF") then
                {
			if ($standing == 0) then
			{
				send stand
...
APPRAISE_COMBAT:
	if ("%APPRAISE_COMBAT" = "false") then
	{
		var APPRAISE_COMBAT true
		return
	}
	if ("%APPRAISE_COMBAT" = "true") then
	{
		var APPRAISE_COMBAT false
		pause .2
		if matchre ("$monsterlist", "\b(%nonskinnablecritters)\b") then var Monster $0
		if matchre ("$monsterlist", "\b(%skinnablecritters)\b") then var Monster $0
		if matchre ("$monsterlist", "\b(%invasioncritters)\b") then var Monster $0
		pause .2
		put appraise %Monster quick
		pause 1
		send analyze %Monster
                pause 1
                send %COMMAND
                pause .5
		return
...
TACTICSTRAIN:
	var LAST TACTICSTRAIN
	matchre NEXT_TACT Roundtime|You aren't close enough|You must be closer
...
if $mana < 85 then waiteval $mana >= 85
	...
	waitforre (^A nagging sense of desperation guides|^As you begin to solemnly intone the|^Heatless orange flames blaze between|^Icy blue frost crackles up your arms|^Images of streaking stars falling|^The wailing of lost souls accompanies|^Tiny tendrils of lightning jolt|^With great force|^With no small amount of effort|^You are already preparing|^You begin chanting|^You close your eyes|^You deftly waggle your fingers in the precise|^You hastily shout the arcane phrasings|^You have to strain|^You lick the tip of your finger and trace a sigil in the air|^You mutter a foul-sounding|^You raise your arms skyward, chanting|^You struggle against your bindings to prepare|^You trace an arcane sigil in the air,|^Your eyes darken to black as a starless|^Your skin briefly withers and tightens)
...
MAGIC_TARGET_WAIT1:
	...
	if ("%FULL_PREP" = "YES") then goto MAGIC_CAST
		match MAGIC_CAST Your formation of a targeting pattern around
...
FATIGUE:
	...
	var LAST FATIGUE
		matchre FATIGUE \[You're beat,|You stop advancing
		matchre STAND You must stand first|^You should stand up first|^You had better stand up first
...
MANIPULATE1:
	send manipulate friendship first $manipulate
	matchre return ^You strain, but cannot extend your will any further|^Manipulate what
	matchwait 1
	wait
	send manipulate friendship second $manipulate
	matchre return ^You strain, but cannot extend your will any further|^Manipulate what
	wait
	return

TMPARALYSIS:
	var number %numbers(%paralysis.index)
	if $mana < 85 then waiteval $mana >= 85
	send release all
	waitforre ^You let your concentration lapse and feel the spell's energies dissipate|^You release the mana you were holding|^You aren't preparing a spell|^You aren't holding any mana
	send prep Paralysis 10
	waitforre ^A nagging sense of desperation guides|^As you begin to solemnly intone the|^Heatless orange flames blaze between|^Icy blue frost crackles up your arms|^Images of streaking stars falling|^The wailing of lost souls accompanies|^Tiny tendrils of lightning jolt|^With great force|^With no small amount of effort|^You are already preparing|^You begin chanting|^You close your eyes|^You deftly waggle your fingers in the precise|^You hastily shout the arcane phrasings|^You have to strain|^You lick the tip of your finger and trace a sigil in the air|^You mutter a foul-sounding|^You raise your arms skyward, chanting|^You struggle against your bindings to prepare|^You trace an arcane sigil in the air,|^Your eyes darken to black as a starless|^Your skin briefly withers and tightens
	send target %number $paralysis
	matchre TMPARALYSIS_CAST ^You begin to weave mana lines into a target pattern around
	matchre TMPARALYSIS_NEXT ^There is no need to target
	matchre TMPARALYSIS_FAIL ^I could not find what you were referring to
	matchwait 2
TMPARALYSIS_CAST:
	pause
	send harness 6
	...
	send cast
	matchre TMPARALYSIS_END ^A stream of translucent, golden energy shoots from the palm of your hand towards
...
ARRANGEIT:
		...
		matchre ARRANGING ^You begin to arrange|^You continue arranging
		matchre SKINNING ^You complete arranging
	if "$charactername" = "Atanamir" then put arrange all
	else put arrange %Monster skin
	matchwait 5
	goto %LAST
...
STOW_JUNK:
	var LAST STOW_JUNK
		...
		matchre GET_JUNK_PAUSE so you decide to wait and see if they will collect it first\.$|But that is already in your inventory\.$
...
GET_JUNK_PAUSE:
	...
	put get %JUNK
	pause
	put put %JUNK in my %JUNK_CONTAINER
	pause
	goto LOOT_JUNK_ON
...
EXPCHECK_ON:
##CHECK HERE
##	if ($%EXP2.LearningRate > 33) then goto SWITCH_WEAPON
##			else if ($%WEAPON_EXP.LearningRate > 33) then goto SWITCH_WEAPON
##		}
##	} else if ($%WEAPON_EXP.LearningRate > 33) then goto SWITCH_WEAPON
	if ("%ALTEXP" = "ON") then
	{
		if ($%EXP2.LearningRate > 32) then
		{
			if ($%EXP2.LearningRate > 32) then goto SWITCH_WEAPON
...
EXPCHECK_OFF:
	...
	put #statusbar 1 GH - Kills:$GH_KILLS :$GH_SKINS  Loots:$GH_LOOTS
...
SWITCH_STANCE:
##CHECK HERE
##if ($%CURR_STANCE.LearningRate < 34) then return
	if ($%CURR_STANCE.LearningRate < 16) then return
	if ("%GAG_ECHO" != "YES") then
	{
		echo
		echo ***     SWITCH_STANCE:    ***
...
SWITCH_WEAPON:
	...
	if "$IGNITE" != "OFF" && "$GH_BUFF" = "ON" then
	{
		put #send release ignite
		waitforre ^The warm feeling in your hand goes away|^RELEASE Options
	}
	#put stance evasion
	#pause .5
	put #playsystem Open
...
BARRAGE.CHECK:
##	put #var GH_Debilitation_Counter 1
	var DebilitationSpell FB
	pause .2
	matchre BARRAGE causing a low hum to vibrate through your bones\.$|^A charge dances just below|^Elemental essence floats freely within your body|^Elemental essence has infused every inch of your body|^Extraplanar power crackles within your body|^Your body sings and crackles|^You have reached the limits
	matchre RETURN Only magic could detect the useless trace|^A small charge|^A charge dances through
	put #send pathway sense
	matchwait

BARRAGE:
	put #var GH_BARRAGE_ALLOW ON
	pause .2
	return
...
BARRAGE.WAIT:
	pause .2
	if ("$GH_BARRAGE_FULL_TARGET" = "ON") then return
	pause .2
	goto BARRAGE.WAIT.PAUSE
...
HELP_SWAP:
	...
	echo **
	echo ** SYNTAX: .hunt SWAP {1/2/E/B/PI/HA/SS/QS} {weapon} (shield)
	echo **
	...
	echo **
	echo ** EXAMPLES: .hunt SWAP 1 sword shield - uses a sword in 1-handed mode
	echo **           .hunt SWAP PI spear - uses a spear in pike mode
	echo **************************************************************************************
	echo
	pause 3
	goto HELP
