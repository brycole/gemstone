...
put hug %god orb
     ...
     match orb-altar You sense that your sacrifice is properly prepared
     matchwait
orb-altar:
     gosub display Traveling...
     gosub move 2
...
display:
     setvariable text $0
     if %display = 1 then put #statusbar Getting %quantity favors from %god. %favorsgot favors gained so far. --- [ %text ] --- If you like this script please send a tip to Gavinne@play.net via Paypal
     if %display = 2 then put #statusbar Getting %quantity favors from %god. %favorsgot favors gained so far. --- [ %text ] --- Or contact XLNOTHINGLX on AIM and ask about the awesome scripts we sell!
     math display add 1
