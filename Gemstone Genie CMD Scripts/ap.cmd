...
echo = Last edited: 11/19/09
echo = Edited by: Mozzik
echo = Version 3.0
echo =
...
action var retry 1 when The streams of mana writhe violently before settling into new patterns\.$
var retry 0
...
enterAP:
    ...
    match StartIsEnd You are pulled through
    put cast %Start
    matchwait
...
error_badStart:
    echo
    echo You are not at a known Grazhir shard
    echo and you either lack the 100th ability or       
    echo you didnt include the 4th vari          
    goto cleanup
error_expanse:
    echo
