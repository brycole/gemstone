...
routinepvpalerts:
	put #var player_threats Xionara|Phaetyl|Koranan|Arkanax|Sepherus|Scarekrow|Fahijeck|Sepharus|Khras|Evro
...
#	action if !matchre("%resonance", "alert3|travel") then var alerts $0|$1;goto player_alert_3 when ^You can sense .* presence of (%player_threats)\.
	...
	action if !matchre("%resonance", "alert3|travel") then var alerts $0|$1;goto player_alert_3 when ^\*.+\b(?!assassin|intercessor|kelpie|giant)\w+ (fires|throws) a.*at you\.
	...
	return
	action goto player_alert_2 when Nebby hurls
