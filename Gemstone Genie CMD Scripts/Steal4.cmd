...
## FOR EOTC AND ROC CHOOSE EITHER ON or OFF
     var EOTB ON
	var eotbMana 20
     var ROC ON
	var rocMana 7
...
FINISHED.SCRIPT:
	...
	put #echo >Log Lime *** Start City: %CITY | End City: %CURRENT.CITY
     ...
     put #echo >Log Lime *** Profit: %Plat Plat, %Gold Gold, %Silver Silver, %Bronze Bronze and %Copper Copper
	...
	echo **** Profit: %Plat Plat, %Gold Gold, %Silver Silver, %Bronze Bronze and %Copper Copper
	echo ***************************************************************************************
     pause 6
