...
action (stalk) off
action (combos) var _COMBO $1 when by landing (.*)\.$
...
var buff.charge.total2 TOTAL1|TOTAL2|TOTAL3
#var buff.spell MAF|EASE|GAF|LW|REPR|NAME|ECRY|RAGE|DRUM|HARMONY|MIS
#var buff.prep 5|1|5|6|5|30|1|15|15|30|15
#var buff.charge.total 101|98|100|110|100|100|100|100|100|100|100
...
var buff.2cambrinth $2cambrinth
var buff.worn YES
var buff.remove NO
var buff.harness NO
...
var buff.charge.total TOTAL1|TOTAL2|TOTAL3
var buff.charge.total2 TOTAL1|TOTAL2|TOTAL3
#var buff.spell MAF|EASE|GAF|LW
#var buff.prep 5|1|5|6
#var buff.charge.total 101|98|100|110
var buff.charge.increment 10
var buff.harness.total TOTAL1|TOTAL2|TOTAL3
var buff.harness.increment 10
var buff.cambrinth $cambrinth
...
var buff.charge.total TOTAL1|TOTAL2|TOTAL3
var buff.charge.total2 TOTAL1|TOTAL2|TOTAL3
#var buff.spell MAF|IC|TRANQUILITY|REFRESH|AGS|EASE|GOL|MEF|VIGOR|INNOCENCE|BS|GAF|FP|CD|HL|LW|AWAKEN|RP
#var buff.prep 5|5|15|1|5|1|5|5|15|5|5|5|15|15|15|6|15|15
#var buff.charge.total 101|100|100|100|100|98|100|100|100|95|100|100|100|100|100|110|100|100
var buff.charge.increment 10
var buff.harness.total TOTAL1|TOTAL2|TOTAL3
var buff.harness.increment 10
var buff.cambrinth $cambrinth
...
var buff.charge.total TOTAL1|TOTAL2|TOTAL3
var buff.charge.total2 TOTAL1|TOTAL2|TOTAL3
#var buff.spell MAF|PG|SHADOWS|EASE|TS|CV|AUS|SEER|GAF|LW|PSY
#var buff.prep 5|5|1|1|5|1|5|14|5|6|5
#var buff.charge.total 101|102|100|98|98|97|99|100|100|110|100
var buff.charge.increment 10
var buff.harness.total TOTAL1|TOTAL2|TOTAL3
var buff.harness.increment 10
var buff.cambrinth $cambrinth
...
var buff.charge.total TOTAL1|TOTAL2|TOTAL3
var buff.charge.total2 TOTAL1|TOTAL2|TOTAL3
#var buff.spell MAF|OBFUSCATION|EASE|GAF|LW
#var buff.prep 5|2|1|5|6
#var buff.charge.total 101|101|98|100|110
var buff.charge.increment 10
var buff.harness.total TOTAL1|TOTAL2|TOTAL3
var buff.harness.increment 10
var buff.cambrinth $cambrinth
...
var buff.charge.total TOTAL1|TOTAL2|TOTAL3
var buff.charge.total2 TOTAL1|TOTAL2|TOTAL3
#var buff.spell AA|MAF|HES|COURAGE|DIG|EASE|SR|RW|DA|MO|CLARITY|GAF|BA|BOT|HOJ|LW|SP|RUE|CRC|AS
#var buff.prep 1|5|1|5|5|1|5|5|15|15|15|5|10|15|5|6|15|15|30|15
#var buff.charge.total 100|101|100|100|100|98|100|100|100|100|100|100|100|100|100|110|100|100|100|100
var buff.charge.increment 10
var buff.harness.total TOTAL1|TOTAL2|TOTAL3
var buff.harness.increment 10
var buff.cambrinth $cambrinth
...
var buff.charge.total TOTAL1|TOTAL2|TOTAL3
var buff.charge.total2 TOTAL1|TOTAL2|TOTAL3
#var buff.spell EY|MAF|STW|EASE|SOTT|INST|HOL|WOTP|COTC|EM|GAF|MON|LW
#var buff.prep 5|5|1|1|10|1|5|10|15|20|5|30|6
#var buff.charge.total 100|101|100|98|100|100|100|100|100|100|100|100|110
var buff.charge.increment 10
var buff.harness.total TOTAL1|TOTAL2|TOTAL3
var buff.harness.increment 10
var buff.cambrinth $cambrinth
...
var buff.charge.total TOTAL1|TOTAL2|TOTAL3
var buff.charge.total2 TOTAL1|TOTAL2|TOTAL3
#var buff.spell ES|MAF|VOI|EASE|SUBSTRATUM|SUF|TW|SW|YS|GAF|LW
#var buff.prep 1|5|15|1|5|5|5|5|15|5|6
#var buff.charge.total 100|101|100|98|100|100|100|100|100|100|110
var buff.charge.increment 10
var buff.harness.total TOTAL1|TOTAL2|TOTAL3
var buff.harness.increment 10
var buff.cambrinth $cambrinth
...
action var _COMBO $1 when by landing (.*)\.$
put info
waitforre ^Debt:$
put awaken
...
SKIN:
	...
	var BELT_WORN OFF
	action var BELT_WORN ON when ^You are wearing.+(belt|outdoors|ritualist'?s?|skinning|wrist) (blade|knife)
	put inventory
	waitforre ^You are wearing
	action remove ^You are wearing.+(belt|outdoors|ritualist's|skinning|wrist) (blade|knife)
	put #var GH_SKIN ON
...
COMBAT_COMMAND:
	...
	if ((toupper("$GH_AMBUSH") = "ON") && ($hidden != 1)) then
	{
		...
		elseif (($Stealth.LearningRate < 34)) then gosub HIDE
	}
...
ATTACK:
var LAST ATTACK
if ($Tactics.LearningRate < 34 && $GH_TACTICS = ON && !matchre("%WEAPON_EXP", "Bow|Crossbow|Slings")) then gosub TACTICSTRAIN
...
DO_ANALYZE:
	var LAST DO_ANALYZE
	matchre ANALYZEDONE ^Roundtime|^You recall your combo|^Your analysis
...
ANALYZEDONE:
	...
	eval _COMBO replacere("%_COMBO", "(,?\s?((an|a)|and (an|a))\s)", "|")
	eval _combocount count("%_COMBO", "|")
...
ANALYZE_FINAL:
	...
	gosub maneuver %_COMBO(%this.attack)
...
## } else if ($%WEAPON_EXP.LearningRate > 33) then goto SWITCH_WEAPON
	...
	if (("%MAGIC" = "OFF") && (("%EXP2" = "Primary_Magic") || ("%EXP2" = "Targeted_Magic")) && ($%EXP2.LearningRate > 33)) then goto SWITCH_WEAPON
	}
	else if ($%WEAPON_EXP.LearningRate > 33) then goto SWITCH_WEAPON
...
if %buff.charge.total2(%c) > %buff.charge.current then
	...
	if %buff.charge.increment <= %charge.difference then put charge my %buff.2cambrinth %buff.charge.increment
	else put charge my %buff.2cambrinth %charge.difference
	waitforre (^The .+\.$|^\.\.\.wait|^Sorry, you|You strain)
	var buff.cambrinth.result $0
	if matchre ("%buff.cambrinth.result", "absorbs") then
		{
...
matchre buff.return ^The .+ pulses with \w+ energy\.  You reach for its center and forge a magical link to it|^Your link to the .+ is intact
put invoke my %buff.2cambrinth %buff.charge.total2(%c)
matchwait
...
matchre buff.return ^You attach|^You slide|^You wear
